...
// Clase obtenida cuando se consulta la información de un personaje
...
public class Person {
	...
	// Todos los atributos anteriores se obtenían directamente del objeto devuelto por la consulta
