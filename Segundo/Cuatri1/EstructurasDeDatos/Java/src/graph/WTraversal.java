...
import dataStructures.graph.Store;
...
public abstract class WTraversal<V,W> {
	...
	abstract public dataStructures.graph.Store<WDiEdge<V,W>> newStore(); // will be defined in subclasses to return different kinds of stores
	...
	private abstract class BaseIterator {
		...
		protected dataStructures.graph.Store<WDiEdge<V,W>> store;     // diEdges to vertices yet to be explored
