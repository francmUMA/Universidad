...
% A RELLENAR POR EL ALUMNO
% ------------------------
fft_res1_real = fft(res1_real, longitud);
magnitud_fft_res1_real = abs(fft_res1_real);
figure(3);
subplot(2,1,2); plot(EjeX(1:(longitud/16)+1), magnitud_fft_res1_real(1:(longitud/16)+1)); grid;
xlabel('Frecuencia(Hz)'); ylabel('|ECG|');
...
% A RELLENAR POR EL ALUMNO
% ------------------------
res2_z = fft_res1_real .* H3_normalizado;
...
% A RELLENAR POR EL ALUMNO
% ------------------------
fft_res2_real = fft(res2_real, longitud);
magnitud_fft_res2_real = abs(fft_res2_real);
figure(4);
subplot(2,1,2); plot(EjeX(1:(longitud/16)+1), magnitud_fft_res2_real(1:(longitud/16)+1)); grid;
xlabel('Frecuencia(Hz)'); ylabel('|ECG|');
...
H5 = (5 + 4*exp(-1 * 1i * w) + 3 * exp(-2 * 1i * w) + 2 * exp(-3 * 1i * w) + exp(-4 * 1i * w) - exp(-6 * 1i * w) - 2 * exp(-7 * 1i * w) - 3 * exp(-8 * 1i * w) - 4 * exp(-9 * 1i * w) - 5 * exp(-10 * 1i * w)) ./ 110;
% ------------------------
% A RELLENAR POR EL ALUMNO
% ------------------------
...
% A RELLENAR POR EL ALUMNO
% ------------------------
res3_z = fft_res2_real .* H5_normalizado;
...
% A RELLENAR POR EL ALUMNO
% ------------------------
fft_res3_real = fft(res3_real, longitud);
magnitud_fft_res3_real = abs(fft_res3_real);
figure(5);
subplot(2,1,2); plot(EjeX(1:(longitud/16)+1), magnitud_fft_res3_real(1:(longitud/16)+1)); grid;
xlabel('Frecuencia(Hz)'); ylabel('|ECG|');
...
% A RELLENAR POR EL ALUMNO
% ------------------------
res4_compleja = res3_compleja .* res3_compleja;
res4_real = real(res4_compleja);
